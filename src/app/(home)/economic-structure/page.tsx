  ...
  return (
    <main className="text-white px-40 py-20 bg-gradient-to-br from-slate-800 to-slate-950">
        ...
        <div className="ml-6 text-2xl font-medium flex flex-col gap-5 mt-10">
          ...
          <div className="flex flex-col gap-5 ml-10">
            <div className="flex flex-col gap-3 items-start">
              ...
              <p className="text-lg">
                La independencia de Perú en 1821 permitió el establecimiento de
                una economía nacional independiente, lo que facilitó la creación
                de políticas económicas propias.
              </p>
            </div>
            <div className="flex flex-col gap-3 items-start">
            ...
            <div className="flex flex-col gap-3 items-start">
              <h4 className="text-xl font-medium">- Políticas Neoliberales</h4>
              <p className="text-lg">
          ...
          <div className="flex flex-col gap-5 ml-10">
            ...
            <div className="flex flex-col gap-3 items-start">
              ...
              <p className="text-lg">
                ...
                infraestructura, lo que ha limitado su desarrollo económico y su
                capacidad para conectarse eficazmente con el resto del país.
              </p>
            </div>
            <div className="flex flex-col gap-3 items-start">
              <h4 className="text-xl font-medium">
        ...
        <div>
            ...
            <div className="flex flex-col gap-5 ml-10 mt-10 max-w-[800px]">
              ...
              <div className="flex flex-col gap-3 items-start">
                ...
                <p className="text-lg">
                  ...
                  actividades industriales como la manufactura, la construcción,
              ...
              <div className="flex flex-col gap-3 items-start">
                ...
                <p className="text-lg">
                  ...
                  Esto incluye comercio, transporte, turismo, educación, salud,
          ...
          <div>
            ...
            <p className="mt-8 text-lg">
              Históricamente, la economía peruana ha dependido de la explotación
              de recursos naturales, especialmente minería, agricultura, y
              pesca.
            </p>
          ...
          <div>
            ...
            <p className="mt-8 text-lg">
              La economía de la región de Huánuco ha dependido de la explotación
              en gran medida de la producción agrícola y ganadera
            </p>
            <div className="flex gap-20 mt-10 justify-center">
              <div className="flex flex-col items-center w-max">
                <p className="font-semibold text-center">
      ...
      <section>
        ...
        <div>
          ...
          <div className="mt-10 ml-10">
            ...
            <p className="text-lg mt-5">
              El Mincetur participa en el Grupo Técnico de Turismo de la Alianza
              del Pacífico, con un trabajo orientado al cumplimiento de los
              mandatos de las declaraciones suscritas por los presidentes de los
              4 países del bloque.
            </p>
          ...
          <div className="text-lg flex flex-col gap-5 mt-10">
            <p>
              ...
              69.4% (US$ 15,182 millones). Les siguieron los productos diversos
              (US$ 2,507 millones, 11.5%), los agrícolas (US$ 2,252 millones,
              10.3%), los pesqueros (US$ 1,384 millones, 6.3%) y los textiles
              (US$ 544 millones, 2.5%).
            </p>
            <p>
              China sigue siendo el principal destino para nuestras
              exportaciones al bloque APEC, al cierre del primer semestre de
              2024, al concentrar un 35.1% de nuestras ventas globales y el 53%
              de nuestras exportaciones al APEC, con US$ 11,607 millones
              (+2.8%). Le siguen EE. UU. (US$ 3,604 millones; -13%), Canadá (US$
              1,696 millones; +27.1%), Japón (US$ 1,635 millones; +25.3%) y
              Corea del Sur (US$ 1,116 millones; -14.1%).
            </p>
          </div>
          <h3 className="font-semibold mt-16 text-2xl">
          ...
          <div className="text-lg flex flex-col gap-5 mt-10">
            <p>
              ...
              exportación de minerales (+US$ 4 millones), principalmente, cobre
              (+US$ 3,3 millones), zinc (+US$ 416 mil), concentrados de plata
              (+US$ 96 mil) y antimonio (+US$ 88 mil).
            </p>
            <p>
              Por el contrario, la agroexportación cayó 4% debido a las menores
              ventas de legumbres (-57%) - en especial de arvejas (-100%) y
              frijoles (-54%)-, y café (-65%). No obstante, crecieron las ventas
              de papaya andina (+409%), follaje mixto (+302%), kudzu (+173%),
              quinua (+75%) y palta (+29%).
            </p>
            <p>
              La exportación de cacao, el 1º producto agropecuario exportado en
              la región, totalizó US$ 3 millones, 14% más que en 2022.
              Destacaron las ventas de cacao en polvo (+212%), pasta de cacao
              (+138%) y manteca de cacao (+43%). El cacao de la región se
              destina principalmente a la Unión Europea (58% del total) y EE.UU.
              (28%).
            </p>
            <p>
              También se incrementaron las exportaciones a Chile (+400%: papaya
              andina), Corea del Sur (+458%: palta) y Estados Unidos (+6%:
              cacao). No obstante, se redujeron los despachos a Colombia (-52%:
              frijoles), Canadá (-39%: chocolate), Hong Kong (-30%: palta) y
              Reino Unido (-15% chocolate).
            </p>
          </div>
        </div>
      </section>
      <section>
        ...
        <div className="text-lg flex flex-col gap-5 mt-10">
          <p>
            En Perú, las políticas de desarrollo económico y social se basan en
            el modelo de Economía Social de Mercado, adoptado en la Constitución
            de 1979 y reafirmado en el Acuerdo Nacional de 2002. Este modelo
            promueve el crecimiento económico a través de la iniciativa privada,
            con un Estado que regula y fomenta. Las políticas clave incluyen:
          </p>
          <ul className="flex flex-col gap-3 ml-4">
            ...
            <li>
              - Coordinar esfuerzos entre economistas y médicos para vincular la
              salud con el crecimiento económico.
            </li>
            <li>
        ...
        <div className="text-lg flex flex-col gap-5 mt-10">
          ...
          <ul className="flex flex-col gap-3 ml-4">
            ...
            <li>
              - Mejorar la infraestructura de los centros educativos y contratar
              psicólogos en todas las instituciones educativas.
            </li>
            <li>
              - Elaborar un plan para incluir a los niños, niñas y adolescentes
              que no acceden a la educación básica regular.
            </li>
          </ul>
        </div>
      </section>
      <section>
        ...
        <div>
          ...
          <div className="mt-10 ml-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg">
                Persisten disparidades significativas entre las áreas urbanas y
                rurales, lo que complica el desarrollo inclusivo.
              </p>
            </div>
            <div className="flex flex-col gap-2">
              <h4 className="text-xl font-medium">Crisis Educativa y Salud</h4>
              <p className="text-lg">
        ...
        <div>
          ...
          <div className="mt-10 ml-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg">
                Crecimiento de la economía digital, Perú tiene la oportunidad de
                modernizar sus industrias y mejorar la productividad.
              </p>
            </div>
            <div className="flex flex-col gap-2">
              <h4 className="text-xl font-medium">
              ...
              <p className="text-lg">
                A pesar de los desafíos, se proyecta un crecimiento moderado en
                sectores como la manufactura y la construcción, con tasas
        ...
        <div>
          ...
          <div className="mt-10 ml-5 flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg">
                Estos fenómenos representan un desafío continuo para la región,
                que deberá adaptar sus actividades económicas para mitigar estos
                efectos.
              </p>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <p className="text-lg">
                ...
                desafíos en términos de desarrollo equitativo, especialmente en
                áreas rurales donde el acceso a servicios básicos sigue siendo
                limitado.
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          <div className="mt-10 ml-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <h4 className="text-xl font-medium">Exportación y Innovación</h4>
              <p className="text-lg">
                Huánuco tiene el potencial de desarrollar productos
                especializados en cada uno de sus valles, con miras a la
                exportación. El apoyo a la agroexportación y la transferencia de
                tecnología a través de programas como Procompite.
              </p>
            </div>
            <div className="flex flex-col gap-2">
              <h4 className="text-xl font-medium">
      ...
      <section>
        ...
        <ul className="flex flex-col gap-[14px] text-lg ml-5 mt-10">
          ...
          <li>
            - Andina, A. P. de N. (n.d.). Perú es un ejemplo en política social
            y mejora de programas sociales. Gob.Pe.
          ...
          <li>
            - Lorenzo, C. B. V. P. (n.d.). Crecimiento económico y su influencia
            en el desarrollo de la región Huánuco. Https://Dialnet.Unirioja.Es/.
